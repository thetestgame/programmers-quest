...
from quest.distributed.database import AstronDatabaseInterface
from quest.distributed.messenger import NetMessenger
...
class AstronClientRepository(ClientRepositoryBase, singleton.Singleton):
    """
...
class AstronInternalRepository(ConnectionRepository, singleton.Singleton):
    """
