...
from quest.login import account
...
class PlayFabLoginOperation(QuestLoginManagerOperation):
    ...
    def _handle_account_retrieved(self, dclass: object, fields: object) -> None:
        ...
        assert dclass == self.login_manager.air.dclassesByName[account.QuestAccountUD.__name__], 'Received an invalid account dclass type'
        self.account = fields
    ...
    def _handle_create_account(self) -> None:
        ...
        account_inst = account.QuestAccountUD(self.playfab_id)
        ...
        self.login_manager.air.dbInterface.createObject(
            ...
            self.login_manager.air.dclassesByName[account.QuestAccountUD.__name__],
            self.account,
